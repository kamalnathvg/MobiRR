...
internal data class ReleaseDto(
    ...
    val indexerFlags: List<String> = listOf(),
    @SerialName("indexerId")
    val indexerId: Int = 0,
    @SerialName("infoHash")
    ...
    @SerialName("mappedMovieId")
    val mappedMovieId: Int? = null,
    @SerialName("movieTitles")
    val movieTitles: List<String> = listOf(),
    @SerialName("protocol")
    val protocol: DownloadProtocol = DownloadProtocol.UNKNOWN,
    @SerialName("publishDate")
    val publishDate: String = "",
    @SerialName("quality")
    val quality: Quality,
    @SerialName("qualityWeight")
    val qualityWeight: Int = 0,
    @SerialName("rejected")
    val rejected: Boolean = false,
    @SerialName("rejections")
    val rejections: List<String>? = null,
    @SerialName("releaseGroup")
    val releaseGroup: String? = null,
    @SerialName("releaseHash")
    val releaseHash: String? = null,
    @SerialName("releaseWeight")
    val releaseWeight: Int = 0,
    @SerialName("sceneSource")
    val sceneSource: Boolean = false,
    @SerialName("seeders")
    val seeders: Int? = null,
    @SerialName("size")
    val size: Long = 0,
    @SerialName("temporarilyRejected")
